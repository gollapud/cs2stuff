...
public class LinkedQuadTree<E> extends AbstractQuadTree<E> {
  ...
  public Position<E> addNW(Position<E> p, E e)
    ...
    Node<E> nw = createNode(e, parent, null, null, null, null);
    parent.setNW(nw);
    size++;
    return nw;
  }
  ...
  public Position<E> addNE(Position<E> p, E e)
    ...
    Node<E> ne = createNode(e, parent, null, null, null, null);
    parent.setNE(ne);
    size++;
    return ne;
  }
  ...
  public Position<E> addSW(Position<E> p, E e)
    ...
    Node<E> sw = createNode(e, parent, null, null, null, null);
    parent.setSW(sw);
    size++;
    return sw;
  }
  ...
  public Position<E> addSE(Position<E> p, E e)
    ...
    Node<E> se = createNode(e, parent, null, null, null, null);
    parent.setSE(se);
    size++;
    return se;
  }
